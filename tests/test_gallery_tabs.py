...
class TestGalleryTabsScope:
    ...
    def test_is_global_scope_folder(self, qapp: Any) -> None:
        """Folder tab active means is_global_scope() returns False."""
        tabs = GalleryTabs()
        tabs.setCurrentIndex(0)
        assert tabs.is_global_scope() is False

    def test_is_global_scope_all_images(self, qapp: Any) -> None:
