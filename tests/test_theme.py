...
class TestQssGeneration:
    """Generated QSS is valid and respects design constraints."""

    def test_qss_file_exists_and_is_readable(self) -> None:
    ...
    def test_qss_does_not_use_forbidden_properties(self) -> None:
...
class TestApplyTheme:
    """MainWindow theme application sets a non-empty stylesheet."""

    def test_apply_theme_no_exception(self, qapp: Any, mock_settings: Any) -> None:
        """MainWindow._apply_theme() applies the stylesheet without raising."""
    ...
    def test_apply_theme_sets_stylesheet(self, qapp: Any, mock_settings: Any) -> None:
...
class TestMotionConstants:
    """Motion duration constants match the design tokens."""

    def test_motion_duration_fast_value(self) -> None:
        """DURATION_FAST matches the tokens.json motion.duration_fast value (150 ms)."""
        assert DURATION_FAST == 150

    def test_motion_duration_normal_value(self) -> None:
...
class TestBadgeColorConstants:
    """Badge hue color constants are valid and distinct."""

    def test_all_badge_hue_colors_exist(self) -> None:
        """Every badge hue has both bg and fg QColor constants."""
    ...
    def test_badge_bg_and_fg_are_different(self) -> None:
