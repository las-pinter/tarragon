...
class TestGetBadgeColors:
    """The get_badge_colors() function returns the correct scheme for each extension."""

    @pytest.mark.parametrize(
        "ext",
        ["psd", "PSD", ".psd", ".PSD", "Psd", ".Psd"],
    )
    def test_get_badge_colors_psd_variants(self, ext: str) -> None:
    ...
    def test_get_badge_colors_unknown_extensions(self, ext: str) -> None:
    ...
    def test_get_badge_colors_strips_dot(self) -> None:
    ...
    def test_get_badge_colors_case_insensitive(self) -> None:
...
class TestBadgeColorConstants:
    """BADGE_COLORS and DEFAULT_BADGE_COLORS expose valid QColor tuples."""
    ...
    def test_default_badge_colors_is_qcolor_tuple(self) -> None:
